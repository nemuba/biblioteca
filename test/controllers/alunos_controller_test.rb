...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { curso_id: @aluno.curso_id, email: @aluno.email, nome: @aluno.nome, ra: @aluno.ra } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { curso_id: @aluno.curso_id, email: @aluno.email, nome: @aluno.nome, ra: @aluno.ra } }
