...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { ano_publicacao: @livro.ano_publicacao, autor: @livro.autor, curso_id: @livro.curso_id, materia_id: @livro.materia_id, semestre_id: @livro.semestre_id, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { ano_publicacao: @livro.ano_publicacao, autor: @livro.autor, curso_id: @livro.curso_id, materia_id: @livro.materia_id, semestre_id: @livro.semestre_id, titulo: @livro.titulo } }
