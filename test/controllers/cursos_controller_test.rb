...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { descricao: @curso.descricao, duracao: @curso.duracao, periodo: @curso.periodo, semestre_id: @curso.semestre_id } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { descricao: @curso.descricao, duracao: @curso.duracao, periodo: @curso.periodo, semestre_id: @curso.semestre_id } }
