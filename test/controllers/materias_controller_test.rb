...
class MateriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materia" do
    assert_difference('Materia.count') do
      post materias_url, params: { materia: { carga_horaria: @materia.carga_horaria, curso_id: @materia.curso_id, descricao: @materia.descricao } }
    end
  ...
  test "should update materia" do
    patch materia_url(@materia), params: { materia: { carga_horaria: @materia.carga_horaria, curso_id: @materia.curso_id, descricao: @materia.descricao } }
